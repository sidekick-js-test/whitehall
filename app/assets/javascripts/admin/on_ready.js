jQuery(document).ready(function($) {
  ...
  if(typeof ieVersion === 'undefined'){
    $(".chzn-select-non-ie").addClass('chzn-select');
  }
  window.setTimeout(function(){
    $(".chzn-select:visible").chosen({allow_single_deselect: true, search_contains: true});
    $(".chzn-select-no-deselect:visible").chosen({allow_single_deselect: false, search_contains: true});
  }, 9);
